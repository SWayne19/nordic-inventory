...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $products = [
            ...
            ['name' => 'Insulation Box for Heat Exchanger Ba-12', 'price' => 15000, 'stock' => 100],

            // Underfloor Heating
            ['name' => 'Underfloor Heating Manifold - 2 ways', 'price' => 180000, 'stock' => 15],
            ['name' => 'Underfloor Heating Manifold - 5 ways', 'price' => 240000, 'stock' => 12],
            ...
            ['name' => 'Expansion Vessel for Potable Water 8L', 'price' => 58000, 'stock' => 30],
            ...
            ['name' => 'Ball Valve with Thermometer Blue/Red set', 'price' => 28000, 'stock' => 80],
